        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-2 border-t border-slate-100 pt-3">
            ...
            <div className="flex items-center gap-1.5 flex-wrap w-full sm:w-auto">
              {attachedTemplate ? (
                <span className="inline-flex items-center gap-1.5 pl-3 pr-1.5 py-1 rounded-full bg-slate-900 text-white text-xs font-semibold shadow-2xs max-w-full">
                  <GithubIcon className="w-3.5 h-3.5 shrink-0" />
                  <span className="truncate max-w-[150px] sm:max-w-none">{attachedTemplate.name}</span>
                  <button
                    type="button"
