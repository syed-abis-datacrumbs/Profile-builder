          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-2.5">
            ...
            {isApplied && onRemove && (
              <button
                type="button"
                onClick={onRemove}
                className="flex items-center gap-1.5 px-3 py-2 rounded-full bg-slate-100 hover:bg-rose-50 text-slate-600 hover:text-rose-600 border border-slate-200 hover:border-rose-200 text-sm font-semibold transition-colors cursor-pointer"
            ...
            <div className="px-6 pb-6 pt-0">
              ...
              <div className="flex items-start justify-between">
                <div className="-mt-14 sm:-mt-20 w-[110px] h-[110px] sm:w-[130px] sm:h-[130px] rounded-full border-[4px] border-white overflow-hidden relative bg-slate-200 shadow-md shrink-0">
                  ...
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src={getHeadshotForName(sample.fullName)}
                    alt={sample.fullName}
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2.5">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-[12px] text-slate-500 line-clamp-1 leading-tight font-normal mt-0.5">
                    {sample.headline || 'Software Engineer | AI & Cloud Architecture'}
                  </p>
              ...
              <div className="border-t border-slate-100 pt-2 flex items-center justify-around text-slate-500">
          ...
          {sample.projects.length > 0 && (
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
              ...
              <div className="space-y-3.5">
                {(showAllProjects ? sample.projects : sample.projects.slice(0, 2)).map((proj, idx) => (
                  <div
                    key={idx}
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 w-full">
                      <h3 className="text-[15px] sm:text-[16px] font-bold text-[#191919] leading-tight">
                        {proj.title}
                      </h3>

                      {/* Project Date Range */}
                      <p className="text-[12.5px] text-slate-500 font-normal mt-0.5">
                        {proj.date || (idx === 0 ? 'May 2022 – Nov 2022' : 'Jun 2021 – Nov 2021')}
                      </p>

                      {/* Project Description */}
                      <p className="text-[13px] text-slate-700 leading-snug mt-1.5 line-clamp-3">
                        {proj.description}
                      </p>
                    </div>
                  </div>
                ...
                <div className="border-t border-slate-100 pt-3.5 mt-4 text-center">
                  ...
                  >
                    <span>
                      {showAllProjects
                        ? 'Show less'
                        : `Show all ${sample.projects.length} projects`}
                    </span>
                    <ChevronRight
