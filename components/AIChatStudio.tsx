      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.map((msg) => (
          ...
          >
            ...
            <div
              className={`p-4 rounded-2xl text-xs leading-relaxed space-y-2 [word-break:normal] [overflow-wrap:break-word] break-words min-w-0 ${
                msg.sender === 'user'
                  ? 'bg-indigo-600 text-white shadow-md'
                  : 'bg-slate-900 border border-slate-800 text-slate-200 shadow-xl'
              }`}
            >
              <p className="whitespace-pre-wrap [word-break:normal] [overflow-wrap:break-word] break-words">{msg.text}</p>
