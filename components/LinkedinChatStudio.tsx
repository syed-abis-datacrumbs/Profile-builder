        ...
        <div className="shrink-0 flex items-center justify-between px-2.5 sm:px-4 py-2 sm:py-2.5 border-b border-slate-200 bg-white gap-1.5 sm:gap-2">
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            <button
              ...
              className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1.5 rounded-lg bg-blue-50 hover:bg-blue-100 text-[#0A66C2] transition-colors text-xs font-bold border border-blue-200 cursor-pointer shadow-2xs shrink-0"
