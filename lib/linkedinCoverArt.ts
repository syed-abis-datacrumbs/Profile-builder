...
export const COVER_ART: Record<string, CoverArtTemplate> = {
  ...
  'paid-marketing': { id: 'paid-marketing', backgroundUrl: '/images/linkedin-banners/banner-4.png', canvasWidthPx: 1584, canvasHeightPx: 396, fields: [] },
  'ideas-inspire': { id: 'ideas-inspire', backgroundUrl: '/images/linkedin-banners/banner-2.png', canvasWidthPx: 1584, canvasHeightPx: 396, fields: [] },
  'lets-work-together': {
    ...
    fields: [
      {
        ...
        maxLength: 25,
        geometry: { xPct: 0.03, yPct: 0.16, maxWidthPct: 0.35, align: 'left', fontSizePx: 33, fontWeight: 600, color: '#ffffff', fontFamily: FONT_POPPINS, maxLines: 1 },
      },
      {
        id: 'name',
        kind: 'text',
        ...
        maxLength: 25,
        geometry: { xPct: 0.685, yPct: 0.22, maxWidthPct: 0.28, align: 'left', fontSizePx: 70, fontWeight: 700, color: '#ffffff', fontFamily: FONT_BRICOLAGE, lineHeightPx: 65, maxLines: 2 },
      },
      {
        id: 'title',
        kind: 'text',
        ...
        maxLength: 35,
        geometry: { xPct: 0.685, yPct: 0.45, maxWidthPct: 0.28, align: 'left', fontSizePx: 34, fontWeight: 500, color: '#ffffff', maxLines: 1 },
      },
    ],
  },
  ...
  'yellow-wave': { id: 'yellow-wave', backgroundUrl: '/images/linkedin-banners/banner-5.png', canvasWidthPx: 1584, canvasHeightPx: 396, fields: [] },
  'ai-engineer-badge': { id: 'ai-engineer-badge', backgroundUrl: '/images/linkedin-banners/banner-2.png', canvasWidthPx: 1584, canvasHeightPx: 396, fields: [] },
  ...
  'ui-ux-designer': { id: 'ui-ux-designer', backgroundUrl: '/images/linkedin-banners/banner-1.png', canvasWidthPx: 1584, canvasHeightPx: 396, fields: [] },
  'graphic-designer': { id: 'graphic-designer', backgroundUrl: '/images/linkedin-banners/banner-1.png', canvasWidthPx: 1584, canvasHeightPx: 396, fields: [] },
  'video-editor': { id: 'video-editor', backgroundUrl: '/images/linkedin-banners/banner-4.png', canvasWidthPx: 1584, canvasHeightPx: 396, fields: [] },
  ...
  'technical-writer': { id: 'technical-writer', backgroundUrl: '/images/linkedin-banners/banner-3.png', canvasWidthPx: 1584, canvasHeightPx: 396, fields: [] },
